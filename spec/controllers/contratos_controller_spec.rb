...
RSpec.describe ContratosController, type: :controller do
  ...
  describe "GET #new" do
    it "assigns a new contrato as @contrato" do
      ...
      expect(assigns(:contrato)).to be_a_new(Contrato)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created contrato as @contrato" do
        post :create, {:contrato => valid_attributes}, valid_session
        expect(assigns(:contrato)).to be_a(Contrato)
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved contrato as @contrato" do
        post :create, {:contrato => invalid_attributes}, valid_session
        expect(assigns(:contrato)).to be_a_new(Contrato)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested contrato" do
        contrato = Contrato.create! valid_attributes
        put :update, {:id => contrato.to_param, :contrato => new_attributes}, valid_session
        contrato.reload
    ...
    context "with invalid params" do
      it "assigns the contrato as @contrato" do
        contrato = Contrato.create! valid_attributes
        put :update, {:id => contrato.to_param, :contrato => invalid_attributes}, valid_session
        expect(assigns(:contrato)).to eq(contrato)
      end
