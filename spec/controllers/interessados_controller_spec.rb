...
RSpec.describe InteressadosController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all interessados as @interessados" do
      ...
      expect(assigns(:interessados)).to eq([interessado])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested interessado as @interessado" do
      ...
      expect(assigns(:interessado)).to eq(interessado)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new interessado as @interessado" do
      ...
      expect(assigns(:interessado)).to be_a_new(Interessado)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created interessado as @interessado" do
        post :create, {:interessado => valid_attributes}, valid_session
        expect(assigns(:interessado)).to be_a(Interessado)
        expect(assigns(:interessado)).to be_persisted
      end

      it "redirects to the created interessado" do
        post :create, {:interessado => valid_attributes}, valid_session
        expect(response).to redirect_to(Interessado.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved interessado as @interessado" do
        post :create, {:interessado => invalid_attributes}, valid_session
        expect(assigns(:interessado)).to be_a_new(Interessado)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested interessado" do
        interessado = Interessado.create! valid_attributes
        put :update, {:id => interessado.to_param, :interessado => new_attributes}, valid_session
        interessado.reload
      ...
      it "redirects to the interessado" do
        interessado = Interessado.create! valid_attributes
        put :update, {:id => interessado.to_param, :interessado => valid_attributes}, valid_session
        expect(response).to redirect_to(interessado)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the interessado as @interessado" do
        interessado = Interessado.create! valid_attributes
        put :update, {:id => interessado.to_param, :interessado => invalid_attributes}, valid_session
        expect(assigns(:interessado)).to eq(interessado)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the interessados list" do
      interessado = Interessado.create! valid_attributes
      delete :destroy, {:id => interessado.to_param}, valid_session
      expect(response).to redirect_to(interessados_url)
    end
  end
