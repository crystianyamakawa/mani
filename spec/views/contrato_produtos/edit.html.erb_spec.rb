...
RSpec.describe "contrato_produtos/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit contrato_produto form" do
    render

    assert_select "form[action=?][method=?]", contrato_produto_path(@contrato_produto), "post" do
