...
RSpec.describe "opp_produtos/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit opp_produto form" do
    render

    assert_select "form[action=?][method=?]", opp_produto_path(@opp_produto), "post" do
