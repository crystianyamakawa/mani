...
RSpec.describe "fin_movimentos/new", type: :view do
  before(:each) do
    assign(:fin_movimento, FinMovimento.new(
  ...
  it "renders new fin_movimento form" do
    render

    assert_select "form[action=?][method=?]", fin_movimentos_path, "post" do
