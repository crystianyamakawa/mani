...
RSpec.describe "oportunidades/new", type: :view do
  before(:each) do
    assign(:oportunidade, Oportunidade.new(
      :nm_contato => "MyString",
      :tp_retorno => "MyString",
      :ds_retorno => "MyString",
      :cliente_id => 1,
  ...
  it "renders new oportunidade form" do
    render

    assert_select "form[action=?][method=?]", oportunidades_path, "post" do
