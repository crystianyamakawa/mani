...
RSpec.describe "ordem_servico_itens/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit ordem_servico_iten form" do
    render

    assert_select "form[action=?][method=?]", ordem_servico_iten_path(@ordem_servico_iten), "post" do
