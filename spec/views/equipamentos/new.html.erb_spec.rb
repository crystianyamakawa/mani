...
RSpec.describe "equipamentos/new", type: :view do
  before(:each) do
    assign(:equipamento, Equipamento.new(
      :codigo => "MyString",
      :descricao => "MyString",
      :tipo => "MyString",
      :marca_id => 1,
  ...
  it "renders new equipamento form" do
    render

    assert_select "form[action=?][method=?]", equipamentos_path, "post" do
